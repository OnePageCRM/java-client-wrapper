...
public class NoteSerializer extends BaseSerializer {
    ...
    public static Note fromJsonObject(JSONObject noteObject) {
        ...
        return new Note()
                ...
                .setUserIdsToNotify(toListOfStrings(noteObject.optJSONArray(USER_IDS_TO_NOTIFY)))
    ...
    public static String toJsonObject(Note note) {
        ...
        addJsonArray(toJsonStringArray(note.getUserIdsToNotify()), noteObject, USER_IDS_TO_NOTIFY);
